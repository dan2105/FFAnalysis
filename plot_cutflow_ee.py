...
INPUT_FILE = "output_histograms_electrons_loose/data.root"
HIST_NAME  = "Cutflow_CutFlow_ee_loose_ttbar"
OUTPUT_PDF = "Plots/cutflow_ee_loose.pdf"
OUTPUT_PNG = "Plots/cutflow_ee_loose.png"
...
# eixos
#canvas
ax.set_title("Cut Flow - (HILoose W.P.)", fontsize=14, fontweight="bold")
# frame
...
ax.text(0.68, 0.92, "$t\\bar{t} \\to e^{+}e^{-} b\\bar{b} \\nu \\bar{\\nu}$", transform=ax.transAxes,
